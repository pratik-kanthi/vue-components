...
export default {
    ...
    data () {
        return {
            token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..g2JGjSCKWN0JDIUKGT3QrGbp2WLzJgCVEQPx4paFra8',
            columns: [
                {
                    'key': 'Hostname'
                },
