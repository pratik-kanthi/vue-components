<template>
    <div class="form-group">
        <component :is="component" :options="{ ...$props }" :value="value" @updateValue="sendValue" :display-mode="displayMode ? displayMode : $parent.displayMode" :property="property" :select-from="selectFrom"></component>
    ...
    methods: {
        ...
        loadFieldComponentFromModel() {
            if (this.property.type.name === 'String') {
                ...
                else if (this.property.phone || this.phone) return () => import('./Phone.vue');
